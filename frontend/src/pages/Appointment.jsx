...
const Appointment = () => {
  ...
  const { doctors, currency,backendUrl,token,getDoctorData } = useContext(AppContext);
  ...
  return (
    docInfo && (
      <div>
        ...
        {/* Booking Slots */}
        <div className="sm:ml-78 m-pl-4 mt-4 font-medium text-gray-700">
          <p>Booking Slots</p>
          ...
          <div className="flex items-center gap-3 w-full overflow-x-scroll flex-nowrap mt-4 scrollbar-thin scrollbar-thumb-blue-500 scrollbar-track-gray-300">
            {docSlots.length > 0 &&
